...
int main(){
    ...
    Graph_SP g8(6);
    g8.AddEdge(0,1,5);g8.AddEdge(0,2,3);
    g8.AddEdge(1,2,2);g8.AddEdge(1,3,6);
    g8.AddEdge(2,3,7);g8.AddEdge(2,4,4);g8.AddEdge(2,5,2);
    g8.AddEdge(3,4,-1);g8.AddEdge(3,5,1);
    g8.AddEdge(4,5,-2);

    g8.DAG_SP(1);        // 以vertex(0)作為起點
